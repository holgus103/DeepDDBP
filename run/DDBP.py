...
PARTITION = 0.66
SET_SIZE = 600000
EXPERIMENT = "no_trump_l_104_52_13_p104_c_2_imbalanced_dichotomy_test"
...
(samples_l, samples_r, outputs, diffs) = dp.generate_balanced_classes(data, labels, 320000, 160000, 320000);
(test_samples_l, test_samples_r, test_outsputs, test_diffs) = dp.generate_balanced_classes(test_data, test_labels, 160000, 80000, 160000);
...
# train whole network
c.train(data_batches_l, data_batches_r, outputs_batches, 0.0001, 15000, 0.0001, path +"/finetuning", samples_l, samples_r, outputs, diffs, test_samples_l, test_samples_r, test_outsputs, test_diffs, data, labels, test_data, test_labels, dp.suit_count_for_params(TRAIN_NO_TRUMP, TRAIN_TRUMP), dp.suit_count_for_params(TEST_NO_TRUMP, TEST_TRUMP), models.Model.mse_loss, 25, experiment_name);
